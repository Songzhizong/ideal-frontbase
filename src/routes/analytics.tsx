			...
			<div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
				<div className="space-y-3">
					...
					<p className="max-w-2xl text-sm text-muted-foreground sm:text-base">
						Monitor revenue movement, activation trends, and retention cohorts with live context.
					</p>
				</div>
				...
				<Card className="lg:col-span-2">
					...
					<CardContent className="space-y-4 text-sm text-muted-foreground">
						<div className="rounded-3xl border border-border bg-background p-6 text-sm text-muted-foreground">
							<p className="text-sm font-semibold text-foreground">Visualization placeholder</p>
				...
				<Card>
					...
					<CardContent className="space-y-4 text-sm text-muted-foreground">
						<div className="space-y-2">
							<p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Objectives</p>
