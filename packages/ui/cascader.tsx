    ...
    >
      <PopoverTrigger asChild>
        <div
          ...
          className={cn(
            "border-input dark:bg-input/30 focus-visible:border-ring focus-visible:ring-ring/50 flex min-h-9 w-full items-center justify-between gap-2 rounded-md border bg-transparent px-3 py-1.5 text-sm shadow-xs outline-none focus-visible:ring-[3px]",
            ...
            {selectedOptionsList.length === 0 ? (
              ...
              <span className="flex flex-wrap items-center gap-1">
                {visibleTags.map((item) => {
                  ...
                  return (
                    <Badge key={pathToKey(path)} variant="secondary" className="max-w-[16rem]">
