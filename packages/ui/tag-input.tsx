...
export function TagInput({
  ...
  return (
    <div
      data-slot="tag-input"
      className={cn(
        "border-input bg-input-background focus-within:border-ring focus-within:ring-ring/50 flex min-h-9 w-full flex-wrap items-center gap-1 rounded-md border px-2 py-1.5 shadow-xs transition-[color,box-shadow] focus-within:ring-[3px]",
    ...
    >
      {tags.map((tag) => (
        <Tag
          ...
          variant="solid"
          color="secondary"
          className={cn("max-w-[16rem]", tagClassName)}
        >
      ...
      <input
        ...
        className={cn(
          "min-w-24 flex-1 border-none bg-transparent px-1 text-sm text-foreground outline-none placeholder:text-muted-foreground focus-visible:ring-0 focus-visible:ring-offset-0 disabled:cursor-not-allowed",
          inputClassName,
        )}
      />
