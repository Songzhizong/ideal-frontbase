    ...
    >
      <PopoverTrigger asChild>
        <div
          ...
          className={cn(
            "border-input bg-input-background focus-visible:border-ring focus-visible:ring-ring/50 flex min-h-9 w-full items-center justify-between gap-2 rounded-md border px-3 py-1.5 text-sm shadow-xs outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50",
            ...
            {selectedNodes.length === 0 ? (
              ...
              <span className="flex flex-wrap items-center gap-1">
                {visibleTags.map((node) => (
                  <Tag key={node.key} variant="solid" color="secondary" className="max-w-[12rem]">
                ...
                {hiddenCount > 0 ? <Tag variant="outline">+{hiddenCount}</Tag> : null}
              </span>
            ) : (
