  ...
  return (
    <section className="relative overflow-hidden py-20 lg:py-32">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-[20%] left-[20%] h-[500px] w-[500px] rounded-full bg-primary/5 blur-[100px]" />
        <div className="absolute top-[10%] right-[10%] h-[400px] w-[400px] rounded-full bg-accent/10 blur-[100px]" />
        <div className="absolute -bottom-[10%] left-[30%] h-[600px] w-[600px] rounded-full bg-secondary/10 blur-[120px]" />
      </div>
...
function CommunityCTA() {
  return (
    <section className="py-24">
      <div className="container mx-auto px-4">
        <div className="relative overflow-hidden rounded-3xl border border-primary/20 bg-gradient-to-b from-primary/5 to-transparent px-6 py-16 text-center md:px-12 md:py-20 shadow-2xl">
