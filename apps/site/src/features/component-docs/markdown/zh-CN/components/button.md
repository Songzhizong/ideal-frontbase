...
<DataTable preset="props" :data="[
  { name: 'color', type: 'ButtonColor | (string & {})', default: `'primary' | 'neutral'`, description: '按钮颜色；Solid/Soft/Link 默认为 primary，其余默认为 neutral。' },
...
<DataTable preset="types" :data="[
  { name: 'ButtonColor', value: `'primary' | 'destructive' | 'success' | 'warning' | 'info' | 'carbon' | 'secondary' | 'accent' | 'neutral'` },
  { name: 'ButtonSize', value: `'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl'` },
  { name: 'ButtonVariant', value: `'solid' | 'pure' | 'plain' | 'outline' | 'dashed' | 'soft' | 'ghost' | 'link'` },
