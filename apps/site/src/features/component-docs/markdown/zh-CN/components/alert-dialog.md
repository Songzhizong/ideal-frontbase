...
<DataTable preset="props" :data="[
  { name: 'variant', type: 'ButtonVariant', default: 'Action=default / Cancel=outline', description: '按钮样式。' },
  { name: 'size', type: 'ButtonSize', default: 'default', description: '按钮尺寸。' },
...
给 `AlertDialogAction` 传 `variant='destructive'`。
